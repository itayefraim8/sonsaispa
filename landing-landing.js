...
ეს არის დამამშვიდებელი და აღმდგენი მასაჟი მათთვის, ვინც ეძებს სასიამოვნო, დაბალანსებულ და კომფორტულ გამოცდილებას.`
  ...
  price: { he: '30 דק׳ – 60₾ · 60 דק׳ – 100₾', en: '30 min – 60₾ · 60 min – 100₾', ru: '30 мин – 60₾ · 60 мин – 100₾', ka: '30 წთ – 60₾ · 60 წთ – 100₾' }
},
...
ეს არის ეფექტური საშუალება აღდგენის, მოძრაობის თავისუფლებისა და ფიზიკური შესაძლებლობების გასაუმჯობესებლად.`
    ...
    price: { he: '30 דק׳ – 80₾ · 60 דק׳ – 130₾', en: '30 min – 80₾ · 60 min – 130₾', ru: '30 мин – 80₾ · 60 мин – 130₾', ka: '30 წთ – 80₾ · 60 წთ – 130₾' }
  },
...
ეს არის მდიდრული და აღმდგენი გამოცდილება, რომელიც უზრუნველყოფს ღრმა სიმშვიდეს, ბალანსსა და განახლებას სხეულისა და გონებისთვის.`
    ...
    price: { he: '30 דק׳ – 90₾ · 60 דק׳ – 140₾', en: '30 min – 90₾ · 60 min – 140₾', ru: '30 мин – 90₾ · 60 мин – 140₾', ka: '30 წთ – 90₾ · 60 წთ – 140₾' }
  },
...
ეს არის იდეალური არჩევანი მათთვის, ვინც ეძებს თბილ, დამამშვიდებელ და აღმდგენ გამოცდილებას სხეულისა და გონებისთვის.`
  ...
  price: { he: '30 דק׳ – 70₾ · 60 דק׳ – 110₾', en: '30 min – 70₾ · 60 min – 110₾', ru: '30 мин – 70₾ · 60 мин – 110₾', ka: '30 წთ – 70₾ · 60 წთ – 110₾' }
},
...
const TREATMENT_PRICES = {
  'body-Thai Oil Massage': { 30: 60, 60: 100 },
  'body-thai': { 30: 60, 60: 100 },
  'body-thai-relax-oil': { 30: 60, 60: 100 },
  'body-thai-hot-oil': { 30: 70, 60: 110 },
  'body-aroma-oil-therapeutic': { 30: 70, 60: 110 },
  'foot-massage': { 30: 60, 60: 100 },
  'body-sports': { 30: 80, 60: 130 },
  'body-deep-tissue-cream': { 30: 80, 60: 120 },
  'body-hot-stone': { 30: 90, 60: 140 },
};
  ...
  buttons.forEach((btn) => {
    btn.addEventListener('click', (e) => {
      ...
      if (group) {
        ...
        if (selectedInput) selectedMinutes = Number(selectedInput.value || 0);
        if (selectedSpan) duration = selectedSpan.textContent.trim();
      }

      const selectedPrice = TREATMENT_PRICES[key]?.[selectedMinutes];
      const priceText = selectedPrice ? `${selectedPrice}₾` : '';
